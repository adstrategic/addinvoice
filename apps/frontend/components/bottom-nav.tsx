...
export function BottomNav() {
  ...
  return (
    <>
          ...
          <Drawer open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            <DrawerTrigger asChild>
              <button
                ...
                className="flex h-14 w-14 items-center justify-center rounded-full bg-linear-to-br from-primary-dark via-primary to-primary-light text-primary-foreground shadow-[0_8px_20px_rgba(0,117,135,0.4)] hover:shadow-[0_12px_25px_rgba(0,117,135,0.6)] hover:-translate-y-1 transition-all duration-300 cursor-pointer"
              >
                <Plus className="h-6 w-6 relative z-10" strokeWidth={2} />
              </button>
            </DrawerTrigger>
      ...
      {!isAnyFormOpen && (
        <nav className="fixed bottom-0 left-0 right-0 z-40 flex h-20 items-center justify-around overflow-hidden px-2 sm:px-4 rounded-t-[2.5rem] border-t border-white/20 dark:border-white/5 bg-background/80 pb-2 backdrop-blur-3xl shadow-[0_-15px_40px_rgba(0,0,0,0.08)] md:hidden">
