...
import { FileText, CheckCircle2, Clock, Calendar, CalendarDays, Plus, TrendingUp, DollarSign } from "lucide-react"
...
const recentInvoices = [
  { id: "INV-001", client: "Acme Corp", amount: 5420, status: "paid", date: "2025-01-15" },
  { id: "INV-002", client: "TechStart Inc", amount: 3280, status: "pending", date: "2025-01-18" },
  { id: "INV-003", client: "Global Solutions", amount: 7650, status: "paid", date: "2025-01-19" },
  { id: "INV-004", client: "Digital Ventures", amount: 4190, status: "pending", date: "2025-01-20" },
  { id: "INV-005", client: "Innovation Labs", amount: 6320, status: "paid", date: "2025-01-21" },
]
            ...
            <Card className="bg-card border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10 hover:-translate-y-1">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  <span className="text-primary font-semibold">+12%</span> from last month
                </p>
              </CardContent>
            </Card>
          </motion.div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      <span className="text-primary font-semibold">+3</span> new invoices
                    </p>
                  </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      <span className="text-primary font-semibold">+8%</span> vs last month
                    </p>
                  </div>
          ...
          <Card className="mb-6 sm:mb-8 bg-card border-border shadow-sm hover:shadow-md transition-shadow duration-300">
            <CardHeader>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <CardTitle className="text-xl sm:text-2xl font-bold text-foreground">Monthly Revenue</CardTitle>
        ...
        >
          <Card className="bg-card border-border shadow-sm hover:shadow-md transition-shadow duration-300">
            <CardHeader>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                  <CardTitle className="text-xl sm:text-2xl font-bold text-foreground">Recent Invoices</CardTitle>
                  <p className="text-sm text-muted-foreground mt-1">Latest invoice activity</p>
                </div>
                <Link href="/invoices">
                  <Button
                    variant="outline"
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="font-semibold text-foreground truncate">{invoice.id}</p>
