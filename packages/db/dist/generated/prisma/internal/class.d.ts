 ...
 * `prisma.workspace`: Exposes CRUD operations for the **Workspace** model.
  ...
  */
     ...
     * `prisma.catalog`: Exposes CRUD operations for the **Catalog** model.
      ...
      * ```
      */
    get catalog(): Prisma.CatalogDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.workspacePaymentMethod`: Exposes CRUD operations for the **WorkspacePaymentMethod** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more WorkspacePaymentMethods
      * const workspacePaymentMethods = await prisma.workspacePaymentMethod.findMany()
      * ```
      */
    get workspacePaymentMethod(): Prisma.WorkspacePaymentMethodDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
