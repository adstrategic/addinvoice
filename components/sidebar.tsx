  ...
  return (
    <div className="flex h-full flex-col bg-card border-r border-border">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border px-6">
        <Image src="/images/adstrategic-icon.png" alt="ADSTRATEGIC" width={32} height={32} className="h-8 w-8" />
        <span className="text-lg font-semibold text-foreground">AdInvoices</span>
      </div>
